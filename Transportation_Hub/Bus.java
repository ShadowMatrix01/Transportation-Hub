 ...
 */
public class Bus extends Hub implements Transport
{
    @Override
    public void setStringDescriptors(String manufacturer, String driver, String fare_inspector, String route, String condition) {
